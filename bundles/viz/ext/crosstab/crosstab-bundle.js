define("resource:sap/basetable/crosstab/library-preload.json", [], function () {
	return '{\n"name":"sap.basetable.crosstab.library-preload",\n"dependencies":["sap.ui.core.library-preload"],\n"modules":{}\n}';
}), define("resource:sap/basetable/crosstab/themes/sap_platinum/library-parameters.json", [], function () {
	return '{\n}\n';
}), define("resource:sap/basetable/crosstab/themes/vi_theme/library-parameters.json", [], function () {
	return '{\n}\n';
