define("scattermatrix-bundle", 
    ["com_sample_scattermatrix-src/js/flow",
    "com_sample_scattermatrix-src/js/propertyeditor/spec",
    //"com_sample_scattermatrix-src/js/contextmenu/spec",
    "css!com_sample_scattermatrix-src/style/default.css"], function(flowDefinition, propertyEditorSpec/*, contextMenuSpec*/, cssStyleDeclaration) {
	var cssString = "",
		rules, i;
	...
	var vizExtBundle = sap.bi.framework.declareBundle({
		...
		"components": [{
			...
			"customProperties": {
				...
				"description": "",
				"icon": {
					"path": "./com_sample_scattermatrix-src/resources/scattermatrix.png"
				},
				"subMenus" : [],
				"category": [],
				"requires": [{
				...
				"resources": [{
					...
					"path": "./com_sample_scattermatrix-src/resources/templates"
				},{
					"key": "sap.viz.controls.openpe.Language.loadPaths",
					"path": "./com_sample_scattermatrix-src/resources/languages/propertyeditor"
				}]
			}
        }]
	});
