define("html-bundle", 
    ["com_sample_html-src/js/flow",
    "com_sample_html-src/js/propertyeditor/spec",
    "css!com_sample_html-src/style/default.css"], function(flowDefinition, propertyEditorSpec, cssStyleDeclaration) {
	var cssString = "",
		rules, i;
		...
		"components": [{
			...
			"customProperties": {
				...
				"resources": [{
					...
					"path": "./com_sample_html-src/resources/templates"
				},{
					"key": "sap.viz.controls.openpe.Language.loadPaths",
					"path": "./com_sample_html-src/resources/languages/propertyeditor"
				}]
			}
        }]
	});
